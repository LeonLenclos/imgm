//
// Important note : This is an edited version of the librairy
// edited by Léon for the Immaga tool, added exit function feature.
//
//
...
function SceneManager(p)
{
    ...
    {
		// Exit previous scene
		if( this.scene !== null && this.scene.hasExit){
